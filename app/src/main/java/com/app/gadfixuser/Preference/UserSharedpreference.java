...
public class UserSharedpreference {
    private static com.app.gadfixuser.Preference.UserSharedpreference userSharedpreference;
    private SharedPreferences sharedPreferences;

    public static com.app.gadfixuser.Preference.UserSharedpreference getInstance(Context context) {
        if (userSharedpreference == null) {
            userSharedpreference = new com.app.gadfixuser.Preference.UserSharedpreference(context);
        }
